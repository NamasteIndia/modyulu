$(function() {
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-2">
                                                                        <div class="checkbox  mt-4">
                                                                            <input class="form-check-input modisoriginal mod-change-item" type="checkbox" ${(moddata.isoriginal == true) ? 'checked': ''}>
    ...
    // event thay doi noi dung mod -> auto save checkbox + editor
    $("body").on("change", ".mod .modisoriginal", function(e){
        autoSaveMod($(this))
    })
    ...
    function autoSaveMod($el){        
        ...
        var mod = $mod.data("mod"),
            ...
            description = $mod.find("textarea.moddescription").val(),
            showinsingle = $mod.find("input.showinsingle").prop("checked");
            modisoriginal = $mod.find("input.modisoriginal").prop("checked");
